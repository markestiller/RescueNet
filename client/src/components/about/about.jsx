        ...
        <div name="About" className="w-full h-screen p-4 md:p-8 lg:p-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 h-screen relative mt-4">
                ...
                <div>
                    ...
                    <div className="flex items-center justify-center  max-w-screen-md mx-auto text-sm lg:text-base">
                        ...
                        security. <br />
                        Here's the scoop: We've revolutionized the way you
                        protect your loved ones and yourself. Our mission is
                        simple yet groundbreaking – offering you a subscription
                        that guarantees your safety and shelter, no matter what
                        is thrown your way. How? It's ingenious. Every month,
                        you invest in your peace of mind, contributing to a
                        collective fund. <br />
                        When disaster strikes, you're not alone. We're your
                        safety net. We've forged partnerships with caring
                        landlords who share our vision. With the funds
                        accumulated, we ensure that there's always a spot ready
                        and waiting for you, fully paid in a lump sum to the
                        landlord. <br />
                        ...
                        this out of the goodness of our hearts alone. <br />
                        We're transparent about it – we do take a slice of that
                        subscription, but it's a small price for the immense
                        value we provide. Your safety, your shelter, your
                        serenity – it's worth every cent. So, whether it's a
                        hurricane howling or a wildfire raging, rest easy
                        knowing that we got your back. <br />
                        Together, we'll weather the storm, emerging stronger,
                        more connected, and fiercely prepared. Join us. Embrace
